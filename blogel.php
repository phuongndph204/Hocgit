        ...
        <div class="sidebar-blog">
          <div class="news-latest">
            ...
            <div class="list-news-latest layered">							
                ...
                <div class="item-article clearfix">                 
                  <div class="post-image">
                    <a href=""><img src="images/blog/n-2.jpg" alt="Saucony hồi sinh mẫu giày chạy bộ cổ điển của mình – Aya Runner"></a>
                  </div>                  
                  <div class="post-content">
                    <h3>
                ...
                <div class="item-article clearfix">                  
                  <div class="post-image">
                    <a href=""><img src="images/blog/n-3.jpg" alt="Nike Vapormax Plus trở lại với sắc tím mộng mơ và thiết kế chuyển màu đẹp mắt"></a>
                  </div>                  
                  <div class="post-content">
                    <h3>
                ...
                <div class="blog-post row">  
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Adidas Falcon nổi bật mùa Hè với phối màu color block" rel="nofollow">
                      <img src="images/blog/n-1.jpg" alt="Adidas Falcon nổi bật mùa Hè với phối màu color block">
                    </a>
                  </div>
                ...
                <div class="blog-post row">           
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Saucony hồi sinh mẫu giày chạy bộ cổ điển của mình – Aya Runner" rel="nofollow">
                      <img src="images/blog/n-2.jpg" alt="Saucony hồi sinh mẫu giày chạy bộ cổ điển của mình – Aya Runner">
                    </a>
                  </div>          
                  <div class="col-md-8 col-xs-12 col-sm-12">
                    <h3 class="blog-post-title">
                ...
                <div class="blog-post row">
                  ...
                  <div class="col-md-4 col-xs-12 col-sm-12">
                    <a href="detailblog.html" class="blog-post-thumbnail" title="Nike Vapormax Plus trở lại với sắc tím mộng mơ và thiết kế chuyển màu đẹp mắt" rel="nofollow">
                      <img src="images/blog/n-3.jpg" alt="Nike Vapormax Plus trở lại với sắc tím mộng mơ và thiết kế chuyển màu đẹp mắt">
                    </a>
                  </div>             
                  <div class="col-md-8 col-xs-12 col-sm-12">
                    <h3 class="blog-post-title">
        ...
        <div class="row">
          ...
          <div class="col-xs-12 col-sm-6 col-md-3">
            <div class="footer-col footer-block">
              ...
              <div class="footer-content toggle-footer">
                <ul>
                  <li><span>Địa chỉ:</span> 13 Phố Trịnh Văn Bô Nam Từ Liêm Hà Nội Việt Nam</li>
                  <li><span>Điện thoại:</span> +84 (028) 38800659</li>
                  <li><span>Fax:</span> +84 (028) 38800659</li>
                  <li><span>Mail:</span> phuongndph33698@fpt.edu.vn</li>
                </ul>
              </div>
            </div>
          </div>
    ...
    <div class="main-footer--copyright">
      <div class="container">
        ...
        <div class="main-footer--border" style="text-align:center;padding-bottom: 15px;">
          <p>Nhóm 8<a href="https://runner-inn.myharavan.com"> WD18311</a>. <a target="_blank"
              href="https://www.facebook.com/henrynguyen202">Nguyễn Đức Phương</a></p>
        </div>
      </div>
    </div>
  </footer>
